...
export const demoScenes = [
  ...
  },
  {
    ...
    scenario: "日常通勤",
    tags: ["车内收纳", "通勤舒适", "氛围感"],
    products: ["车内手机支架", "车载香氛", "车载纸巾盒", "车载水杯"],
    feedLabels: [
      { text: "方向盘套", x: 18, y: 36 },
      { text: "手机支架", x: 42, y: 46 },
      { text: "车载香薰", x: 60, y: 45 },
    ...
    hotspots: [
      {
        ...
        product: "方向盘套",
        label: "方向盘套",
        review: "方向盘套让驾驶触感更稳定，棕色内饰也更统一。",
        productUrl: "#shop-%E6%96%B9%E5%90%91%E7%9B%98%E5%A5%97",
      },
      {
        x: 42,
        y: 46,
        product: "车内手机支架",
        label: "手机支架",
        review: "手机支架固定导航视线，通勤和临停都不用低头找手机。",
      ...
      },
      {
        ...
        product: "车载香氛",
        label: "车载香薰",
        review: "香薰和纸巾盒这些高频物件应该固定在副驾侧，车内更容易恢复整洁。",
...
const shopCategories = [
  {
    ...
    products: [
      ...
      product("方向盘套", "￥99", "贴合棕色内饰，提升握持稳定性和车内整体质感。"),
      product("车载纸巾盒", "￥69", "固定在副驾台面，纸巾随手可取，减少车内零散物。"),
      product("车载水杯", "￥89", "适合通勤和短途补水，放在杯架里不晃动也不占中控空间。"),
    ],
  },
  {
    name: "智能家居",
  ...
  room: [
    {
      ...
      name: "王策",
      meta: "通勤车主",
      text: "手机支架、香薰和纸巾盒这些高频物件固定好，车里就不会每次上车都重新整理。",
    },
    {
      avatar: "乔",
      name: "乔木",
      meta: "车内收纳",
      text: "方向盘套和内饰颜色统一之后，整个车空间会更像一个稳定的私人座舱。",
    },
    {
      avatar: "禾",
      name: "小禾",
      meta: "收藏 9 件",
      text: "遮阳挡、水杯和玩偶都很真实，想看一套适合女生通勤车内的低预算清单。",
    },
  ],
};
